...
path_data=/nfs/dust/cms/user/deleokse/RunII_102X_v2/ZPrime_Original/ZPrime_2018/Analysis_Vars_Multiclass/muon/workdir_Zprime_Analysis_2018_muon/uhh2.AnalysisModuleRunner. 

mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2018_afterNN
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2018_afterNN

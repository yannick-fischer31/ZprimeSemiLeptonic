...
path_data=/nfs/dust/cms/user/deleokse/RunII_102X_v2/ZPrime_Original/ZPrime_2018/Analysis_applyQCD/muon/workdir_Zprime_Analysis_2018/uhh2.AnalysisModuleRunner. 

mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2018_afterQCDNN
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2018_afterQCDNN
